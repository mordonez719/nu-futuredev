...
function Profile(props: ProfileProps) {
    return (
        <div className="border-[#646cffaa]/80 border-1 w-full max-w-xs p-4 hover:shadow-[0_0_1.25em_#646cffaa] hover:translate-y-2 hover:scale-102 will-change-transform duration-300 rounded-md bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]">
            <section className="flex flex-col items-center gap-4">
                {/* Profile Image - Uniform Size */}
                <div className="w-32 h-32 rounded-full overflow-hidden border-2 border-[#646cffaa]">
                    <img 
                        src={props.image} 
                        alt={props.name} 
                ...
                <div className="text-center">
                    ...
                    <p className="text-gray-300">{props.group}</p>
                </div>
                ...
                <div className="flex justify-center gap-4">
                    ...
                    <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="group flex justify-center p-2 rounded-md drop-shadow-xl bg-[#0077b5] text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
                    >
                ...
                {/* View Outline Button */}
                <InteractiveHoverButton className="mt-2">View Outline</InteractiveHoverButton>
            </section>
        </div>
    );
}
